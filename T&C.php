...
<body class="single-page">
    <header class="site-header">
        ...
        src="website/images/reg6.jpg" alt="">
    </header><!-- .site-header -->
...
<br>
                    <div class="row">
                        <div class="col-12 ">
                           <ul>  Meddrive may share your information:</ul>
                           <ul>
                           <li>With concerned persons who need to use the same for the authorised purpose/ providing desired services.</li>
                           <li>To protect and defend the right and property of Meddrive.</li> 
                           <li>Wherever required by law / Govt. Agencies</li>
                           <li>With you, if you may desire so subsequently</li>
                          </ul>
                          <ul>The information shared by you shall not be displayed by Meddrive for any promotional activity.</ul>
                        </div>
...
<br>
                    <div class="w-100 text-center mt-5">
                        <a class="button gradient-bg" href="privacy.php">Read More</a>
                    </div>
                </div>
            </div>
        </div>
