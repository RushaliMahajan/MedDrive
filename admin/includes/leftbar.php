...
<li><a href="#"><i class="fa fa-sitemap"></i> Vehicles</a>
				...
				<li><a href="#"><i class="fa fa-sitemap"></i>Service</a>
					<ul>
						<li><a href="add-providers.php">Add Service Providers</a></li>
						<li><a href="reg-serviceproviders.php">Manage Providers</a></li>
					</ul>
				</li>
